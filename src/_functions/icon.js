...
export const badge = (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" aria-hidden="true" role="img" focusable="false">
		<path d="M14.5,7.5c0,0,0,0-9,0C4.12,7.5,3,8.62,3,10c0,1.38,1.12,2.5,2.5,2.5c9,0,9,0,9,0c1.38,0,2.5-1.12,2.5-2.5
			C17,8.62,15.88,7.5,14.5,7.5z M14.5,10.5c0,0,0,0-9,0v0C5.22,10.5,5,10.28,5,10c0-0.28,0.22-0.5,0.5-0.5c9,0,9,0,9,0
			c0.28,0,0.5,0.22,0.5,0.5C15,10.27,14.78,10.5,14.5,10.5z"/>
    </svg>
);
...
export const bannerEmpty = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<path d="M39,16H9c-1.1,0-2,0.9-2,2v12c0,1.1,0.9,2,2,2h30c1.1,0,2-0.9,2-2V18C41,16.9,40.1,16,39,16z M10,25c-0.6,0-1-0.4-1-1
			s0.4-1,1-1s1,0.4,1,1S10.6,25,10,25z M13,25c-0.6,0-1-0.4-1-1s0.4-1,1-1s1,0.4,1,1S13.6,25,13,25z M16,25c-0.6,0-1-0.4-1-1
			s0.4-1,1-1s1,0.4,1,1S16.6,25,16,25z"/>
	</svg>
);
export const bannerContainerWithHeading = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<path d="M39,16H9c-1.1,0-2,0.9-2,2v12c0,1.1,0.9,2,2,2h30c1.1,0,2-0.9,2-2V18C41,16.9,40.1,16,39,16z M24,26H13v-3h11V26z"/>
	</svg>
);
export const bannerStaticContainerWithHeading = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<path d="M39,18H9c-1.1,0-2,0.9-2,2v8c0,1.1,0.9,2,2,2h30c1.1,0,2-0.9,2-2v-8C41,18.9,40.1,18,39,18z M24,26H13v-3h11V26z"/>
	</svg>
);
export const bannerBottomBarContainerHeading = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<path d="M39,16H9c-1.1,0-2,0.9-2,2v12c0,1.1,0.9,2,2,2h30c1.1,0,2-0.9,2-2V18C41,16.9,40.1,16,39,16z M13,21h11v3H13V21z M40,30
			c0,0.6-0.4,1-1,1H9c-0.6,0-1-0.4-1-1v-2h32V30z"/>
		<rect x="13" y="29" width="7" height="1"/>
	</svg>
);
export const bannerContainerHeadingText = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<path d="M39,16H9c-1.1,0-2,0.9-2,2v12c0,1.1,0.9,2,2,2h30c1.1,0,2-0.9,2-2V18C41,16.9,40.1,16,39,16z M27.5,28h-7v-1h7V28z M29.5,25
			h-11v-3h11V25z"/>
	</svg>
);
export const bannerHeadingTextButtonColor = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<path d="M39,16H9c-1.1,0-2,0.9-2,2v12c0,1.1,0.9,2,2,2h30c1.1,0,2-0.9,2-2V18C41,16.9,40.1,16,39,16z M39,30H9V18h30V30z"/>
		<rect x="18.5" y="20" width="11" height="3"/>
		<rect x="13" y="24" width="22" height="1"/>
		<path d="M26.1,26h-4.1c-0.5,0-0.9,0.4-0.9,0.9v0.1c0,0.5,0.4,0.9,0.9,0.9h4.1c0.5,0,0.9-0.4,0.9-0.9v-0.1C27,26.4,26.6,26,26.1,26z
			"/>
	</svg>
);
...
export const buttons = (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" aria-hidden="true" role="img" focusable="false">
        <path d="M16,7H4C2.9,7,2,7.9,2,9v2c0,1.11,0.9,2,2,2h12c1.1,0,2-0.89,2-2V9C18,7.9,17.1,7,16,7z M13,11c0,0,0,0-6,0v0
          c-0.55,0-1-0.45-1-1c0-0.55,0.45-1,1-1c6,0,6,0,6,0c0.55,0,1,0.45,1,1C14,10.55,13.55,11,13,11z"/>
    </svg>
);
export const button = (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" aria-hidden="true" role="img" focusable="false">
...
export const buttonsTwoButtons = (
    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
...
export const buttonsLabelTextLink = (
    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
...
export const groupsImageParagraphButton = (
    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<rect x="7" y="30" width="34" height="1"/>
		<rect x="7" y="33" width="34" height="1"/>
		<path d="M16.3,36h-8C7.6,36,7,36.4,7,37v1c0,0.6,0.6,1,1.3,1h8c0.7,0,1.3-0.4,1.3-1v-1C17.7,36.4,17.1,36,16.3,36z"/>
		<path d="M7,10v17h34V10H7z M14.5,13c1.4,0,2.5,1.1,2.5,2.5S15.9,18,14.5,18S12,16.9,12,15.5S13.1,13,14.5,13z M38,24H10v-1.8l7-2.2
			l4,2l12-6l5,3.6V24z"/>
    </svg>
);
export const groupsImageHeadingParagraph = (
    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<rect x="7" y="34" width="34" height="1"/>
		<rect x="7" y="30" width="25.5" height="2"/>
		<rect x="7" y="37" width="34" height="1"/>
		<path d="M7,10v17h34V10H7z M14.5,13c1.4,0,2.5,1.1,2.5,2.5S15.9,18,14.5,18S12,16.9,12,15.5S13.1,13,14.5,13z M38,24H10v-1.8l7-2.2
			l4,2l12-6l5,3.6V24z"/>
    </svg>
);
export const groupsImageHeadingParagraphButton = (
    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<rect x="7" y="31" width="34" height="1"/>
		<rect x="7" y="27" width="25.5" height="2"/>
		<rect x="7" y="34" width="34" height="1"/>
		<path d="M16.3,37h-8C7.6,37,7,37.4,7,38v1c0,0.6,0.6,1,1.3,1h8c0.7,0,1.3-0.4,1.3-1v-1C17.7,37.4,17.1,37,16.3,37z"/>
		<path d="M7,7v17h34V7H7z M14.5,10c1.4,0,2.5,1.1,2.5,2.5S15.9,15,14.5,15S12,13.9,12,12.5S13.1,10,14.5,10z M38,21H10v-1.8l7-2.2
			l4,2l12-6l5,3.6V21z"/>
    </svg>
);
...
export const icon = (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" aria-hidden="true" role="img" focusable="false">
		<path d="M10,3c-3.87,0-7,3.13-7,7c0,3.87,3.13,7,7,7c3.87,0,7-3.13,7-7C17,6.13,13.87,3,10,3z M13.08,9.08l-3.75,3.75
			c-0.19,0.19-0.44,0.29-0.71,0.29c-0.27,0-0.52-0.1-0.71-0.29l-1.5-1.5c-0.39-0.39-0.39-1.02,0-1.41c0.39-0.39,1.02-0.39,1.42,0
			l0.79,0.79l3.04-3.04c0.39-0.39,1.02-0.39,1.41,0C13.47,8.06,13.47,8.69,13.08,9.08z"/>
	</svg>
);

export const iconList = (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" aria-hidden="true" role="img" focusable="false">
		<path d="M10,3v3h8V3H10z M4.75,1.88L3.9,3.61L2,3.88l1.37,1.34L3.05,7.12l1.7-0.89l1.7,0.89L6.13,5.22L7.5,3.88L5.6,3.61L4.75,1.88z
			M10,12h8V9h-8V12z M5.79,8.79L4,10.58l-0.29-0.29c-0.39-0.39-1.02-0.39-1.41,0c-0.39,0.39-0.39,1.02,0,1.41l1,1
			C3.48,12.89,3.73,13,4,13c0.27,0,0.52-0.1,0.71-0.29l2.5-2.5c0.39-0.39,0.39-1.02,0-1.41C6.82,8.4,6.18,8.4,5.79,8.79z M10,18h8v-3
			h-8V18z M6.71,14.54c-0.39-0.39-1.02-0.39-1.41,0l-0.54,0.54l-0.54-0.54c-0.39-0.39-1.02-0.39-1.41,0c-0.39,0.39-0.39,1.03,0,1.42
			l0.54,0.54l-0.54,0.54c-0.39,0.39-0.39,1.02,0,1.41c0.2,0.2,0.45,0.29,0.71,0.29c0.26,0,0.51-0.1,0.71-0.29l0.54-0.54l0.54,0.54
			c0.19,0.2,0.45,0.29,0.71,0.29s0.51-0.1,0.71-0.29c0.39-0.39,0.39-1.02,0-1.41L6.16,16.5l0.54-0.54C7.1,15.57,7.1,14.93,6.71,14.54z
			"/>
    </svg>
);
...
export const rowsCol = (
	<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" aria-hidden="true" role="img" focusable="false">
		<path d="M1.29,1.29C1.11,1.48,1,1.74,1,2v16c0,0.26,0.11,0.52,0.29,0.71C1.48,18.89,1.74,19,2,19h16c0.26,0,0.52-0.11,0.71-0.29 
			C18.89,18.52,19,18.26,19,18V2c0-0.26-0.11-0.52-0.29-0.71C18.52,1.11,18.26,1,18,1H2C1.74,1,1.48,1.11,1.29,1.29z M3,8h14v4H3V8z
			M3,17v-3h14v3H3z M17,6H3V3l14,0V6z"/>
	</svg>
);
export const rowsRow = (
	<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" aria-hidden="true" role="img" focusable="false">
		<path d="M1.29,1.29C1.11,1.48,1,1.74,1,2v16c0,0.26,0.11,0.52,0.29,0.71C1.48,18.89,1.74,19,2,19h16c0.26,0,0.52-0.11,0.71-0.29 
			C18.89,18.52,19,18.26,19,18V2c0-0.26-0.11-0.52-0.29-0.71C18.52,1.11,18.26,1,18,1H2C1.74,1,1.48,1.11,1.29,1.29z M3,8h14v4H3V8z
			M3,17v-3h14v3H3z M17,6H3V3l14,0V6z"/>
...
export const rowsFlexStatic = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
	<path d="M39,12H9c-1.1,0-2,0.9-2,2v20c0,1.1,0.9,2,2,2h30c1.1,0,2-0.9,2-2V14C41,12.9,40.1,12,39,12z M39,34H9v-4h30V34z M39,28H9
		V14h30V28z"/>
	</svg>
);
export const rowsStaticFlex = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<path d="M39,12H9c-1.1,0-2,0.9-2,2v20c0,1.1,0.9,2,2,2h30c1.1,0,2-0.9,2-2V14C41,12.9,40.1,12,39,12z M39,34H9V20h30V34z M39,18H9
			v-4h30V18z"/>
	</svg>
);

export const rowsSpaceBetween = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<path d="M39,12H9c-1.1,0-2,0.9-2,2v20c0,1.1,0.9,2,2,2h30c1.1,0,2-0.9,2-2V14C41,12.9,40.1,12,39,12z M39,34H9v-4h30V34z M39,28H9
			v-8h30V28z M39,18H9v-4h30V18z"/>
	</svg>
);

export const rowWithCols = (
	<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" aria-hidden="true" role="img" focusable="false">
...
export const rowWithColsCol = (
	<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" aria-hidden="true" role="img" focusable="false">
		<path d="M18.71,1.29C18.52,1.11,18.26,1,18,1H2C1.74,1,1.48,1.11,1.29,1.29C1.11,1.48,1,1.74,1,2v16c0,0.26,0.11,0.52,0.29,0.71 C1.48,18.89,1.74,19,2,19h16c0.26,0,0.52-0.11,0.71-0.29C18.89,18.52,19,18.26,19,18V2C19,1.74,18.89,1.48,18.71,1.29z M12,3v14H8V3 H12z M3,3h3v14H3V3z M14,17V3h3l0,14H14z"/>
	</svg>
);
export const rowWithCols_1_1_1 = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" aria-hidden="true" role="img" focusable="false">
		<path fill-rule="evenodd" clip-rule="evenodd" d="M41 14a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v20a2 2 0 0 0 2 2h30a2 2 0 0 0 2-2V14zM28.5 34h-9V14h9v20zm2 0V14H39v20h-8.5zm-13 0H9V14h8.5v20z"/>
	</svg>
);
export const rowWithCols_1_1 = (
	<svg width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true" focusable="false">
		<path fill-rule="evenodd" clip-rule="evenodd" d="M39 12C40.1046 12 41 12.8954 41 14V34C41 35.1046 40.1046 36 39 36H9C7.89543 36 7 35.1046 7 34V14C7 12.8954 7.89543 12 9 12H39ZM39 34V14H25V34H39ZM23 34H9V14H23V34Z"/>
	</svg>
);
export const rowWithCols_1_2 = (
	<svg width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true" focusable="false">
		<path fill-rule="evenodd" clip-rule="evenodd" d="M39 12C40.1046 12 41 12.8954 41 14V34C41 35.1046 40.1046 36 39 36H9C7.89543 36 7 35.1046 7 34V14C7 12.8954 7.89543 12 9 12H39ZM39 34V14H20V34H39ZM18 34H9V14H18V34Z"/>
	</svg>
);
export const rowWithCols_2_1 = (
	<svg width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true" focusable="false">
		<path fill-rule="evenodd" clip-rule="evenodd" d="M39 12C40.1046 12 41 12.8954 41 14V34C41 35.1046 40.1046 36 39 36H9C7.89543 36 7 35.1046 7 34V14C7 12.8954 7.89543 12 9 12H39ZM39 34V14H30V34H39ZM28 34H9V14H28V34Z"/>
	</svg>
);
export const rowWithCols_1_2_1 = (
	<svg width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true" focusable="false">
		<path fill-rule="evenodd" clip-rule="evenodd" d="M41 14a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v20a2 2 0 0 0 2 2h30a2 2 0 0 0 2-2V14zM31 34H17V14h14v20zm2 0V14h6v20h-6zm-18 0H9V14h6v20z"/>
	</svg>
);
export const rowWithCols_custom = (
	<svg width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true" focusable="false">
...
export const sectionEmpty = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<path fill-rule="evenodd" clip-rule="evenodd" d="M38.96,30h2l0.01-3h-2L38.96,30z M23,18h3v-2h-3V18z M28,36h3v-2h-3V36z M33,36h3v-2h-3V36z M23,36h3v-2h-3V36z
...
export const sectionContainerHeading = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<path fill-rule="evenodd" clip-rule="evenodd" d="M13,24h22v-3H13V24z M9,23H7v3h2V23z M9,28H7v3h2V28z M9,33H7v2c0,0.26,0.1,0.52,0.29,0.71C7.48,35.89,7.74,36,8,36h3v-2H9
...
export const sectionContainerHeadingTextGallery = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<path fill-rule="evenodd" clip-rule="evenodd" d="M35,20H13v3h22V20z M9,23H7v3h2V23z M9,28H7v3h2V28z M9,18H7v3h2V18z M26,16h-3v2h3V16z M9,14h1v-2H8
...
export const sectionContainerRoundedColoredBanner = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<path fill-rule="evenodd" clip-rule="evenodd" d="M9,23H7v3h2V23z M9,28H7v3h2V28z M9,18H7v3h2V18z M31,16h-3v2h3V16z M9,14h1v-2H8c-0.26,0-0.52,0.1-0.71,0.29
...
export const sectionImgBadgeHeadingTextButtonColumns = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<path d="M9,33H7v2c0,0.3,0.1,0.5,0.3,0.7C7.5,35.9,7.7,36,8,36h3v-2H9V33z"/>
		<rect x="7" y="23" width="2" height="3"/>
		<rect x="7" y="28" width="2" height="3"/>
		<path d="M15.6,14l1.4-1.4l-0.3-0.3C16.5,12.1,16.3,12,16,12h-4v2L15.6,14L15.6,14z"/>
		<rect x="13" y="34" width="3" height="2"/>
		<rect x="7" y="18" width="2" height="3"/>
		<rect x="23" y="16" width="3" height="2"/>
		<path d="M9,14h1v-2H8c-0.3,0-0.5,0.1-0.7,0.3C7.1,12.5,7,12.7,7,13v3h2V14z"/>
		<rect x="28" y="16" width="3" height="2"/>
		<path d="M19.3,17.7c0.2,0.2,0.4,0.3,0.7,0.3h1v-2h-0.6l-2-2L17,15.4L19.3,17.7z"/>
		<path d="M40.7,16.3C40.5,16.1,40.3,16,40,16h-2v2h1l0,2h2l0-3C41,16.7,40.9,16.5,40.7,16.3z"/>
		<rect x="33" y="34" width="3" height="2"/>
		<path d="M39,34h-1v2h2c0.6,0,1-0.4,1-1l0-3h-2L39,34z"/>
		<rect x="33" y="16" width="3" height="2"/>
		<polygon points="39,30 41,30 41,27 39,27 	"/>
		<polygon points="39,25 41,25 41,22 39,22 	"/>
		<rect x="18" y="34" width="3" height="2"/>
		<rect x="23" y="34" width="3" height="2"/>
		<rect x="28" y="34" width="3" height="2"/>
		<rect x="24" y="23" width="11" height="1"/>
		<rect x="24" y="25" width="11" height="1"/>
		<path d="M30,27h-5c-0.5,0-1,0.5-1,1s0.5,1,1,1h5c0.5,0,1-0.5,1-1S30.5,27,30,27z"/>
		<path d="M28.5,22c0.3,0,0.5-0.2,0.5-0.5S28.8,21,28.5,21h-4c-0.3,0-0.5,0.2-0.5,0.5s0.2,0.5,0.5,0.5H28.5z"/>
		<circle cx="17.5" cy="25.5" r="4.5"/>
	</svg>
);
export const sectionBadgeHeadingTextButtonImgColumns = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<rect x="7" y="23" width="2" height="3"/>
		<rect x="7" y="18" width="2" height="3"/>
		<rect x="7" y="28" width="2" height="3"/>
		...
		<rect x="23" y="34" width="3" height="2"/>
		<rect x="28" y="34" width="3" height="2"/>
		<rect x="13" y="23" width="11" height="1"/>
		<rect x="13" y="25" width="11" height="1"/>
		<path d="M14,27c-0.5,0-1,0.5-1,1s0.5,1,1,1h5c0.5,0,1-0.5,1-1s-0.5-1-1-1H14z"/>
		<path d="M17.5,22c0.3,0,0.5-0.2,0.5-0.5S17.8,21,17.5,21h-4c-0.3,0-0.5,0.2-0.5,0.5s0.2,0.5,0.5,0.5H17.5z"/>
		<circle cx="30.5" cy="25.5" r="4.5"/>
	</svg>
);
export const sectionHeadingListColumns = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		<rect x="20" y="20.7" width="8" height="2"/>
		<rect x="7" y="23" width="2" height="3"/>
		<rect x="7" y="18" width="2" height="3"/>
		<rect x="7" y="28" width="2" height="3"/>
		<path d="M15.6,14l1.4-1.4l-0.3-0.3C16.5,12.1,16.3,12,16,12h-4v2L15.6,14L15.6,14z"/>
		...
		<rect x="33" y="16" width="3" height="2"/>
		<rect x="23" y="34" width="3" height="2"/>
		<rect x="13" y="24.7" width="6" height="2"/>
		<rect x="15.5" y="27.7" width="3.5" height="1"/>
		<path d="M14.7,27.6c-0.1-0.1-0.3-0.1-0.5,0l-0.6,0.6l-0.1-0.1c-0.1-0.1-0.3-0.1-0.5,0c-0.1,0.1-0.1,0.3,0,0.5l0.3,0.3
			c0.1,0.1,0.1,0.1,0.2,0.1c0.1,0,0.2,0,0.2-0.1l0.8-0.8C14.9,27.9,14.9,27.7,14.7,27.6z"/>
		<rect x="15.5" y="29.7" width="3.5" height="1"/>
		<path d="M14.3,29.6l-0.6,0.6l-0.1-0.1c-0.1-0.1-0.3-0.1-0.5,0c-0.1,0.1-0.1,0.3,0,0.5l0.3,0.3c0.1,0.1,0.1,0.1,0.2,0.1
			c0.1,0,0.2,0,0.2-0.1l0.8-0.8c0.1-0.1,0.1-0.3,0-0.5C14.6,29.5,14.4,29.5,14.3,29.6z"/>
		<rect x="21" y="24.7" width="6" height="2"/>
		<rect x="23.5" y="27.7" width="3.5" height="1"/>
		<path d="M22.3,27.6l-0.6,0.6l-0.1-0.1c-0.1-0.1-0.3-0.1-0.5,0c-0.1,0.1-0.1,0.3,0,0.5l0.3,0.3c0.1,0.1,0.1,0.1,0.2,0.1
			c0.1,0,0.2,0,0.2-0.1l0.8-0.8c0.1-0.1,0.1-0.3,0-0.5C22.6,27.5,22.4,27.5,22.3,27.6z"/>
		<rect x="23.5" y="29.7" width="3.5" height="1"/>
		<path d="M22.3,29.6l-0.6,0.6l-0.1-0.1c-0.1-0.1-0.3-0.1-0.5,0c-0.1,0.1-0.1,0.3,0,0.5l0.3,0.3c0.1,0.1,0.1,0.1,0.2,0.1
			c0.1,0,0.2,0,0.2-0.1l0.8-0.8c0.1-0.1,0.1-0.3,0-0.5C22.6,29.5,22.4,29.5,22.3,29.6z"/>
		<rect x="29" y="24.7" width="6" height="2"/>
		<rect x="31.5" y="27.7" width="3.5" height="1"/>
		<path d="M30.7,27.6c-0.1-0.1-0.3-0.1-0.5,0l-0.6,0.6l-0.1-0.1c-0.1-0.1-0.3-0.1-0.5,0c-0.1,0.1-0.1,0.3,0,0.5l0.3,0.3
			c0.1,0.1,0.1,0.1,0.2,0.1c0.1,0,0.2,0,0.2-0.1l0.8-0.8C30.9,27.9,30.9,27.7,30.7,27.6z"/>
		<rect x="31.5" y="29.7" width="3.5" height="1"/>
		<path d="M30.3,29.6l-0.6,0.6l-0.1-0.1c-0.1-0.1-0.3-0.1-0.5,0c-0.1,0.1-0.1,0.3,0,0.5l0.3,0.3c0.1,0.1,0.1,0.1,0.2,0.1
			c0.1,0,0.2,0,0.2-0.1l0.8-0.8c0.1-0.1,0.1-0.3,0-0.5C30.6,29.5,30.4,29.5,30.3,29.6z"/>
	</svg>
);
export const sectionBgHeadingIconHeadingTextColumns = (
	<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" role="img" aria-hidden="true" focusable="false">
		...
		<rect x="13" y="30" width="6" height="1"/>
		<rect x="21" y="28" width="6" height="1"/>
		<rect x="21" y="30" width="6" height="1"/>
		<rect x="29" y="28" width="6" height="1"/>
		<rect x="29" y="30" width="6" height="1"/>
		<polygon points="16.7,24.4 16.2,23.3 15.6,24.4 14.3,24.6 15.2,25.5 15,26.7 16.2,26.1 17.3,26.7 17.1,25.5 18,24.6 	"/>
		<path d="M24.9,23.7l-1.2,1.2l-0.2-0.2c-0.3-0.3-0.7-0.3-0.9,0c-0.3,0.3-0.3,0.7,0,0.9l0.7,0.7c0.1,0.1,0.3,0.2,0.5,0.2
			s0.3-0.1,0.5-0.2l1.7-1.7c0.3-0.3,0.3-0.7,0-0.9C25.5,23.4,25.1,23.4,24.9,23.7z"/>
		<path d="M30.9,24.6l0.4,0.4l-0.4,0.4c-0.3,0.3-0.3,0.7,0,0.9c0.1,0.1,0.3,0.2,0.5,0.2s0.3-0.1,0.5-0.2l0.4-0.4l0.4,0.4
			c0.1,0.1,0.3,0.2,0.5,0.2s0.3-0.1,0.5-0.2c0.3-0.3,0.3-0.7,0-0.9L33.1,25l0.4-0.4c0.3-0.3,0.3-0.7,0-0.9c-0.3-0.3-0.7-0.3-0.9,0
			l-0.4,0.4l-0.4-0.4c-0.3-0.3-0.7-0.3-0.9,0C30.6,24,30.6,24.4,30.9,24.6z"/>
	</svg>
);
...
export const slider = (
	<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" aria-hidden="true" role="img" focusable="false">
		<path d="M10,17c-0.55,0-1,0.45-1,1s0.45,1,1,1c0.55,0,1-0.45,1-1S10.55,17,10,17z M7,17c-0.55,0-1,0.45-1,1s0.45,1,1,1
			c0.55,0,1-0.45,1-1S7.55,17,7,17z M13,17c-0.55,0-1,0.45-1,1s0.45,1,1,1s1-0.45,1-1S13.55,17,13,17z M12.61,11.57
			c-0.23-0.56-0.1-1.21,0.33-1.63L14.88,8l-1.94-1.94c-0.43-0.43-0.56-1.07-0.33-1.63S13.39,3.5,14,3.5h2V2c0-0.55-0.45-1-1-1H5
			C4.45,1,4,1.45,4,2v1.5h2c0.61,0,1.15,0.37,1.39,0.93c0.23,0.56,0.1,1.21-0.33,1.63L5.12,8l1.94,1.94
			c0.43,0.43,0.56,1.07,0.33,1.63C7.15,12.13,6.61,12.5,6,12.5H4V14c0,0.55,0.45,1,1,1h10c0.55,0,1-0.45,1-1v-1.5h-2
			C13.39,12.5,12.85,12.13,12.61,11.57z M3,8l3-3H3L0,8l3,3h3L3,8z M17,5h-3l3,3l-3,3h3l3-3L17,5z"/>
	</svg>
);
