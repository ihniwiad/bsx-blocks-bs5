...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"bsx-blocks/check-list","version":"0.1.0","title":"BSX Check List","category":"text","allowedBlocks":["bsx-blocks/check-list-item"],"description":"Create a check list.","example":{},"attributes":{"values":{"type":"string","source":"html","selector":"ul","multiline":"li","__unstableMultilineWrapperTags":["ul"],"default":"","__experimentalRole":"content"},"state":{"type":"string","default":"primary"},"marginLeft":{"type":"string"},"marginRight":{"type":"string"},"marginBefore":{"type":"string"},"marginAfter":{"type":"string"},"display":{"type":"string"},"textAlign":{"type":"string","default":""}},"supports":{"className":false,"__unstablePasteTextInline":true,"__experimentalSelector":"ul","__experimentalSlashInserter":true,"__experimentalOnEnter":true},"textdomain":"bsx-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css"}');
...
const v1 = {
  ...
  save(props) {
    ...
    const [listBlock] = (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.rawHandler)({
      HTML: list.outerHTML
    });
    ...
    */
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.Fragment, {
      children: content && !_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.RichText.isEmpty(content) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.RichText.Content, {
        tagName: "ul",
        value: values,
        className: checklistClassNames
      })
...
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./utils.js */ "./src/check-list/utils.js");
...
function useMigrateOnLoad(attributes, clientId) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    ...
    const [newAttributes, newInnerBlocks] = (0,_utils_js__WEBPACK_IMPORTED_MODULE_9__.migrateToListV2)(attributes);
  ...
  const controls = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        ...
        children: [(0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_8__.stateSelect)(state, onChangeState), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_8__.displaySelect)(display, onChangeDisplay)]
        ...
        children: [(0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_8__.marginLeftSelect)(marginLeft, onChangeMarginLeft, ['', '0', '1', '2', '3']), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_8__.marginRightSelect)(marginRight, onChangeMarginRight, ['', '0', '1', '2', '3']), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_8__.marginBeforeSelect)(marginBefore, onChangeMarginBefore), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_8__.marginAfterSelect)(marginAfter, onChangeMarginAfter)]
      })]
    })]
  });
...
function save({
  ...
  const checklistClassNames = (0,_functions_add_class_names_js__WEBPACK_IMPORTED_MODULE_1__.addClassNames)({
    marginLeft,
    marginRight,
    marginBefore,
    marginAfter,
...
function migrateToListV2(attributes) {
  ...
  const innerBlocks = Array.from(listBlock.innerBlocks).map(listItem => {
    // console.log( '---- listItem: \n' + JSON.stringify( listItem, null, 2 ) );
    if (typeof listItem.attributes !== 'undefined' && typeof listItem.attributes.content !== 'undefined') {
      return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('bsx-blocks/check-list-item', {
...
/* harmony import */ var _edit_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit.js */ "./src/check-list/edit.js");
/* harmony import */ var _save_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save.js */ "./src/check-list/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/check-list/block.json");
/* harmony import */ var _deprecated_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./deprecated.js */ "./src/check-list/deprecated.js");
/**
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  icon: _functions_icon_js__WEBPACK_IMPORTED_MODULE_1__.checkList,
