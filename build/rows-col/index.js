...
/***/ "./src/rows-col/block.json":
/*!*********************************!*\
  !*** ./src/rows-col/block.json ***!
  \*********************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"bsx-blocks/column-rows","version":"0.1.0","title":"BSX Rows","category":"layout","allowedBlocks":["bsx-blocks/column-row"],"description":"Column containing multiple Rows for vertical layouting.","example":{},"attributes":{"templateName":{"type":"string"},"display":{"type":"string","default":"flex"},"flexDirection":{"type":"string","default":"column"},"width":{"type":"string","default":"100"},"justifyContent":{"type":"string"},"multilayer":{"type":"string"},"zIndex":{"type":"string"},"isBannerInner":{"type":"boolean"}},"supports":{"html":false,"className":false},"textdomain":"bsx-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css"}');

/***/ }),

/***/ "./src/rows-col/edit.js":
/*!******************************!*\
  !*** ./src/rows-col/edit.js ***!
  \******************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils.js */ "./src/rows-col/utils.js");
/* harmony import */ var _templates_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./templates.js */ "./src/rows-col/templates.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./editor.scss */ "./src/rows-col/editor.scss");
...
function Edit({
  ...
  let template = (0,_functions_utilities_js__WEBPACK_IMPORTED_MODULE_4__.getTemplate)(_templates_js__WEBPACK_IMPORTED_MODULE_7__["default"], templateName).template;
  let templateLock = (0,_functions_utilities_js__WEBPACK_IMPORTED_MODULE_4__.getTemplate)(_templates_js__WEBPACK_IMPORTED_MODULE_7__["default"], templateName).templateLock;
  const allowedBlocks = ['bsx-blocks/column-row'];
  const onChangeTemplate = value => {
    template = (0,_functions_utilities_js__WEBPACK_IMPORTED_MODULE_4__.getTemplate)(_templates_js__WEBPACK_IMPORTED_MODULE_7__["default"], value).template;
    setAttributes({
      templateName: value
    });
  ...
  let columnsRowsClassNames = (0,_utils_js__WEBPACK_IMPORTED_MODULE_6__["default"])({
    templateName,
    display,
    flexDirection,
    width
  });
  columnsRowsClassNames = (0,_functions_add_class_names_js__WEBPACK_IMPORTED_MODULE_3__.addClassNames)({
    multilayer,
    zIndex,
    isBannerInner
  }, columnsRowsClassNames);
  const controls = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Column Rows layout', 'bsx-blocks'),
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("div", {
          className: "bsxui-icon-text-button-list",
          children: _templates_js__WEBPACK_IMPORTED_MODULE_7__["default"].map((template, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
            label: template.title,
            onClick: () => {
    ...
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorAdvancedControls, {
      children: [(0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_5__.displaySelect)(display, onChangeDisplay, ['', 'flex']), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_5__.flexDirectionSelect)(flexDirection, onChangeFlexDirection), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_5__.widthSelect)(width, onChangeWidth), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_5__.justifyContentSelect)(justifyContent, onChangeJustifyContent), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_5__.multilayerSelect)(multilayer, onChangeMultilayer), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_5__.zIndexSelect)(zIndex, onChangeZIndex), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_5__.bannerInnerToggle)(isBannerInner, onChangeIsBannerInner)]
    })]
  });
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Fragment, {
    children: [!templateName ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
      class: "bsxui-initial-inline-control",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("div", {
        class: "bsxui-initial-inline-control-heading",
        children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Please select Column Rows template', 'bsx-blocks')
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("div", {
        className: "bsxui-icon-text-button-list",
        children: _templates_js__WEBPACK_IMPORTED_MODULE_7__["default"].map((template, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
          label: template.title,
...
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils.js */ "./src/rows-col/utils.js");
...
function save({
  ...
  let columnsRowsClassNames = (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__["default"])({
    templateName,
    display,
    flexDirection,
    width
  });
  columnsRowsClassNames = (0,_functions_add_class_names_js__WEBPACK_IMPORTED_MODULE_1__.addClassNames)({
    multilayer,
    zIndex,
    isBannerInner
  }, columnsRowsClassNames);
...
const templates = [{
  name: 'default-auto',
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Flex, static', 'bsx-blocks'),
  icon: _functions_icon_js__WEBPACK_IMPORTED_MODULE_1__.rowsFlexStatic,
  ...
  name: 'auto-default',
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Static, flex', 'bsx-blocks'),
  icon: _functions_icon_js__WEBPACK_IMPORTED_MODULE_1__.rowsStaticFlex,
  ...
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Space between rows', 'bsx-blocks'),
  icon: _functions_icon_js__WEBPACK_IMPORTED_MODULE_1__.rowsSpaceBetween,
  template: [['bsx-blocks/column-row', {
    columnRowType: 'unset'
  }, [['core/paragraph', {
    placeholder: 'Edit or insert other content and delete paragraph...'
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (makeColumnRowsClassNames);
...
(() => {
/*!*******************************!*\
  !*** ./src/rows-col/index.js ***!
  \*******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _functions_icon_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../_functions/icon.js */ "./src/_functions/icon.js");
/* harmony import */ var _edit_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit.js */ "./src/rows-col/edit.js");
/* harmony import */ var _save_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save.js */ "./src/rows-col/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/rows-col/block.json");
/**
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  icon: _functions_icon_js__WEBPACK_IMPORTED_MODULE_1__.rowsCol,
