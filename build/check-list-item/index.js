...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"bsx-blocks/check-list-item","version":"0.1.0","title":"BSX Check List Item","category":"text","parent":["bsx-blocks/check-list"],"allowedBlocks":[],"description":"Create a check list item.","example":{},"textdomain":"bsx-blocks","attributes":{"content":{"type":"string","source":"html","selector":"li","__experimentalRole":"content"}},"supports":{"anchor":false,"className":false,"splitting":true,"__experimentalSelector":"li","__unstablePasteTextInline":true,"interactivity":{"clientNavigation":true}},"editorScript":"file:./index.js","editorStyle":"file:./index.css"}');
...
/* harmony import */ var _hooks_index_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./hooks/index.js */ "./src/check-list-item/hooks/index.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils.js */ "./src/check-list-item/utils.js");
...
function Edit({
  ...
  const useEnterRef = (0,_hooks_index_js__WEBPACK_IMPORTED_MODULE_7__.useEnter)({
    content,
    clientId
  });
  // const onSplit = useSplit( clientId );
  const onMerge = (0,_hooks_index_js__WEBPACK_IMPORTED_MODULE_7__.useMerge)(clientId, mergeBlocks);
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("li", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
      ref: (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.useMergeRefs)([useEnterRef]),
      identifier: "content",
      tagName: "span",
      ...
      value: content,
      "aria-label": (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('List text'),
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('List')
      // onSplit={ onSplit }
      ,
      onMerge: onMerge,
      onReplace: onReplace ? (blocks, ...args) => {
        onReplace((0,_utils_js__WEBPACK_IMPORTED_MODULE_8__.convertToChecklistItems)(blocks), ...args);
      } : undefined
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   useEnter: () => (/* reexport safe */ _use_enter_js__WEBPACK_IMPORTED_MODULE_0__["default"]),
/* harmony export */   useMerge: () => (/* reexport safe */ _use_merge_js__WEBPACK_IMPORTED_MODULE_1__["default"])
/* harmony export */ });
/* harmony import */ var _use_enter_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./use-enter.js */ "./src/check-list-item/hooks/use-enter.js");
/* harmony import */ var _use_merge_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./use-merge.js */ "./src/check-list-item/hooks/use-merge.js");
...
/* harmony import */ var _edit_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit.js */ "./src/check-list-item/edit.js");
/* harmony import */ var _save_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save.js */ "./src/check-list-item/save.js");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  icon: _functions_icon_js__WEBPACK_IMPORTED_MODULE_1__.checkListItem,
