...
/***/ "./src/_block-variations/core-list.js":
/*!********************************************!*\
  !*** ./src/_block-variations/core-list.js ***!
  \********************************************/
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__.addFilter)('blocks.registerBlockType', 'my-plugin/custom-list-variation', (settings, name) => {
  if (name !== 'core/list') {
    return settings;
  }
  ...
  wp.blocks.registerBlockVariation('core/list', {
    ...
    description: 'A custom list with check marks',
    icon: _functions_icon_js__WEBPACK_IMPORTED_MODULE_2__.checkList,
    attributes: {
...
(() => {
/*!****************************************!*\
  !*** ./src/_block-variations/index.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _core_list_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core-list.js */ "./src/_block-variations/core-list.js");
